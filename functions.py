...
def main():
    ...
    def fitness_func(ga_instance, solution, solution_idx):
        ...
        npScore = np.sum(np.array(score, dtype='f')) * 10000000000000
        # 1/abs(floorArea-numLevels*36*36) * 10
        areaScore = 1 / abs( statistics.mean(floorArea) - numLevels*36*36) * 10000
        scopeScore = statistics.mean(scope) / 10
        # print("====")

        # print(np.array(score))
        # print(np.sum(npScore), 1/abs(floorArea-numLevels*36*36), floorArea)
        # print("Score",  npScore, "areaScore", areaScore, "scopeScore", scopeScore)
        # return 1000000* np.sum(npScore) + 1/abs(floorArea-numLevels*36*36) * 10
        # return np.sum(npScore)
